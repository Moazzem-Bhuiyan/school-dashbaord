...
import CreateCouponeModal from "./CreateCouponeModal";
            ...
            {data ? (
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p>
                            Get access to 20 Downloads per month.
                        </p>
                    </div>
                ...
                <p className="text-gray-500"><Button onClick={() => setSubCriptionPriceModal(true)}>Set Subcription Price</Button></p>
            )}

            <CreateCouponeModal open={SubCriptionPriceModalopen} setOpen={setSubCriptionPriceModal} />
        </div>
    );
};
